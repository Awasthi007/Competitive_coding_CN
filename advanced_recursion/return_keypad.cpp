...
int return_code(int num, string output[])
{
    if(num==0)
    {
        output[0] = "";
...
where k is the number of digits in number N
*/
#include <bits/stdc++.h>
using namespace std;
