...
bool check(long long arr[], int n, long long k, long long mid)
{
	long long count = 0;
    for(int i=0; i<n; i++)
    {
...
long long candy(long long arr[], int n, long long k)
{
    long long start = 0;
    long long end = arr[0];
